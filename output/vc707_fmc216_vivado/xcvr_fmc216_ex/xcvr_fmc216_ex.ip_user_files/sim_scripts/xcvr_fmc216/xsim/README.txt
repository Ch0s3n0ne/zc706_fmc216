...
#
# Generated by export_simulation on Fri Sep 15 16:49:40 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './xcvr_fmc216.sh' script.

./xcvr_fmc216.sh -reset_run
...
./xcvr_fmc216.sh -noclean_files

For more information on the script, please type './xcvr_fmc216.sh -help'.
