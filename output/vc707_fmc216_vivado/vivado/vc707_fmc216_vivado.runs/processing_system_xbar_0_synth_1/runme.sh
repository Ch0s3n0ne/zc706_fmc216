...
HD_PWD='C:/4dsp_test/zc706_fmc216/output/vc707_fmc216_vivado/vivado/vc707_fmc216_vivado.runs/processing_system_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_system_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processing_system_xbar_0.tcl
