...
set_false_path  -from [get_clocks -of [get_pins -of [get_cells -hierarchical -filter {NAME =~ *transceiver_inst/gtwizard_inst/*/gtwizard_i/gt0_GTWIZARD_i/gt*e2_i}] -filter {REF_PIN_NAME =~ RXOUTCLK}]] -to [get_pins -of [get_cells -hierarchical -filter {NAME =~ *rx_elastic_buffer_inst/rd_data_reg*}] -filter {REF_PIN_NAME =~ D}]
