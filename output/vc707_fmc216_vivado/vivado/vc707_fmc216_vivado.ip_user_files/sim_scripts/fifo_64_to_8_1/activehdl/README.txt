...
#
# Generated by export_simulation on Fri Sep 15 15:13:15 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './fifo_64_to_8.sh' script.

./fifo_64_to_8.sh -reset_run
...
./fifo_64_to_8.sh -noclean_files

For more information on the script, please type './fifo_64_to_8.sh -help'.
