################################################################################
# I2C Location assignments (Zedboard pinout, connects to FMC connector)
################################################################################
set_property PACKAGE_PIN R7 [get_ports i2c_scl_0]
set_property IOSTANDARD LVCMOS33 [get_ports i2c_scl_0]

set_property PACKAGE_PIN U7 [get_ports i2c_sda_0]
